...
- **Аудит и регуляторика**: каждый доменный и бизнес‑ивент заворачивается в `AuditEnvelope<T>` и хранится в EventStoreDB; проекции в Postgres для быстрых выборок и отчетов.  
